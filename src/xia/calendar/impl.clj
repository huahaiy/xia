(ns xia.calendar.impl
  ...
  (:require [clojure.string :as str]
            [xia.calendar.backend
             :refer [CalendarBackend
                     auto-detect-service-id
                     backend-create-event
                     backend-default-service-id
                     backend-delete-event
                     backend-find-availability
                     backend-key
                     backend-label
                     backend-list-calendars
                     backend-list-events
                     backend-read-event
...
;; ---------------------------------------------------------------------------
;; Shared service and request helpers
;; ---------------------------------------------------------------------------
...
;; ---------------------------------------------------------------------------
;; Target resolution and operations
;; ---------------------------------------------------------------------------
