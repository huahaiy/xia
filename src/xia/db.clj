...
(defn- template-service-record
  ...
  (cond-> {:id       (:service/id service)
    ...
    (contains? service :service/email-backend)
    (assoc :email-backend (:service/email-backend service))
    (contains? service :service/auth-key)
    (assoc :auth-key (:service/auth-key service))
    (contains? service :service/auth-username)
    (assoc :auth-username (:service/auth-username service))
    ...
    (contains? service :service/smtp-url)
    (assoc :smtp-url (:service/smtp-url service))
    (contains? service :service/email-address)
    (assoc :email-address (:service/email-address service))
    (contains? service :service/imap-security)
    (assoc :imap-security (:service/imap-security service))
    (contains? service :service/smtp-security)
    (assoc :smtp-security (:service/smtp-security service))
    (contains? service :service/inbox-folder)
    (assoc :inbox-folder (:service/inbox-folder service))
    (contains? service :service/drafts-folder)
    (assoc :drafts-folder (:service/drafts-folder service))
    (contains? service :service/sent-folder)
    (assoc :sent-folder (:service/sent-folder service))
    (contains? service :service/archive-folder)
    (assoc :archive-folder (:service/archive-folder service))
    (contains? service :service/trash-folder)
    (assoc :trash-folder (:service/trash-folder service))
